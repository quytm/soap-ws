...
@XmlSeeAlso({
    com.concretepage.site_connect.VehicleAgeRequirementsType.Age.Vehicles.Vehicle.class,
    VehiclePrefType.class,
    VehicleType.class,
    com.concretepage.site_connect.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle.class
})
