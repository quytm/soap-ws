...
@XmlSeeAlso({
    com.concretepage.site_connect.CruiseGuestDetailType.ContactInfo.class,
    com.concretepage.site_connect.HotelRoomListType.Guests.Guest.class,
    com.concretepage.site_connect.HotelRoomListType.MasterContact.class,
    com.concretepage.site_connect.RecipientInfosType.RecipientInfo.class
})
