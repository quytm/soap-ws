...
@XmlSeeAlso({
    com.concretepage.site_connect.OTAHotelAvailRS.RoomStays.RoomStay.class,
    com.concretepage.site_connect.RoomStaysType.RoomStay.class,
    com.concretepage.site_connect.HotelRoomListType.RoomStays.RoomStay.class
})
