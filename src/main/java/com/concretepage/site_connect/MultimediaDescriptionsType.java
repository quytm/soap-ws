...
@XmlSeeAlso({
    com.concretepage.site_connect.HotelInfoType.Descriptions.MultimediaDescriptions.class,
    com.concretepage.site_connect.RestaurantType.MultimediaDescriptions.class,
    com.concretepage.site_connect.AreaInfoType.Recreations.Recreation.MultimediaDescriptions.class
})
