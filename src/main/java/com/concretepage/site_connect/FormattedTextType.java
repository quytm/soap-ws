...
@XmlSeeAlso({
    com.concretepage.site_connect.VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo.class,
    VendorMessageType.class,
    VehicleLocationInformationType.class,
    com.concretepage.site_connect.VehicleLocationVehiclesType.VehicleInfos.VehicleInfo.class,
    com.concretepage.site_connect.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo.class,
    com.concretepage.site_connect.VehicleLocationAdditionalDetailsType.Shuttle.ShuttleInfos.ShuttleInfo.class
})
