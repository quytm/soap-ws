...
@XmlSeeAlso({
    com.concretepage.site_connect.FulfillmentType.PaymentDetails.PaymentDetail.class,
    com.concretepage.site_connect.VehicleReservationRQAdditionalInfoType.RentalPaymentPref.class,
    com.concretepage.site_connect.CruiseGuestInfoType.PaymentOptions.PaymentOption.class
})
