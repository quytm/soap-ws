...
@XmlSeeAlso({
    com.concretepage.site_connect.AirSearchPrefsType.VendorPref.class,
    com.concretepage.site_connect.VehicleAvailRQCoreType.VendorPrefs.VendorPref.class,
    com.concretepage.site_connect.AirlinePrefType.VendorPref.class
})
