...
@XmlSeeAlso({
    com.concretepage.site_connect.OffLocationServiceCoreType.Address.class,
    com.concretepage.site_connect.ItemSearchCriterionType.Address.class,
    AddressInfoType.class,
    com.concretepage.site_connect.AirTravelerType.Address.class
})
