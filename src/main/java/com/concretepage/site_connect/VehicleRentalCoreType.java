...
@XmlSeeAlso({
    com.concretepage.site_connect.VehicleRentalTransactionType.PickUpReturnDetails.class,
    com.concretepage.site_connect.ItineraryItemRequestType.RentalCar.class,
    com.concretepage.site_connect.ItineraryItemResponseType.RentalCar.class
})
