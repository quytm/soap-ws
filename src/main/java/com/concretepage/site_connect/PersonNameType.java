...
@XmlSeeAlso({
    com.concretepage.site_connect.VerificationType.PersonName.class,
    com.concretepage.site_connect.TravelClubType.ClubMemberName.class,
    com.concretepage.site_connect.ContactsType.Name.class,
    com.concretepage.site_connect.OrganizationType.OrgMemberName.class
})
