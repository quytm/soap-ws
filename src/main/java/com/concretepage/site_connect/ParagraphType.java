...
@XmlSeeAlso({
    com.concretepage.site_connect.InvBlockType.BlockDescriptions.BlockDescription.class,
    com.concretepage.site_connect.ProfileType.Comments.Comment.class,
    DescriptionType.class,
    com.concretepage.site_connect.SpecialRequestType.SpecialRequest.class,
    com.concretepage.site_connect.CommentType.Comment.class,
    com.concretepage.site_connect.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    com.concretepage.site_connect.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class
})
