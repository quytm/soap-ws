...
@XmlSeeAlso({
    com.concretepage.site_connect.PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg.class,
    com.concretepage.site_connect.OriginDestinationOptionType.FlightSegment.class
})
