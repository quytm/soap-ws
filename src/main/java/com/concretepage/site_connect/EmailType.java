...
@XmlSeeAlso({
    com.concretepage.site_connect.CompanyInfoType.Email.class,
    com.concretepage.site_connect.EmailsType.Email.class,
    com.concretepage.site_connect.CustomerType.Email.class,
    com.concretepage.site_connect.AirTravelerType.Email.class
})
