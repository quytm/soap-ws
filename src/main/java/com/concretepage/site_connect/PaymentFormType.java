...
@XmlSeeAlso({
    com.concretepage.site_connect.CompanyInfoType.PaymentForm.class,
    com.concretepage.site_connect.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class,
    HotelPaymentFormType.class,
    com.concretepage.site_connect.CustomerType.PaymentForm.class,
