...
@XmlSeeAlso({
    com.concretepage.site_connect.VehicleLocationLiabilitiesType.Coverages.Coverage.CoverageFees.CoverageFee.Vehicles.Vehicle.class,
    com.concretepage.site_connect.VehicleLocationVehiclesType.Vehicle.class,
    com.concretepage.site_connect.VehicleRentalTransactionType.Vehicle.class
})
