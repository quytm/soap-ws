...
@XmlSeeAlso({
    com.concretepage.site_connect.CompanyInfoType.AddressInfo.class,
    com.concretepage.site_connect.CustomerType.Address.class,
    com.concretepage.site_connect.AddressesType.Address.class,
    com.concretepage.site_connect.RequiredPaymentsType.GuaranteePayment.Address.class
})
