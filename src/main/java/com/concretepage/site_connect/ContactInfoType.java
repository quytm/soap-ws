...
@XmlSeeAlso({
    com.concretepage.site_connect.HotelInfoType.OwnershipManagementInfos.OwnershipManagementInfo.class,
    ContactInfoRootType.class,
    com.concretepage.site_connect.AreaInfoType.Attractions.Attraction.Contact.class
})
