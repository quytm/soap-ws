...
@XmlSeeAlso({
    com.concretepage.site_connect.FulfillmentType.PaymentText.class,
    com.concretepage.site_connect.VehicleRentalDetailsType.ConditionReport.class,
    PkgCautionType.class,
    com.concretepage.site_connect.ImageDescriptionType.Description.class,
    com.concretepage.site_connect.TextDescriptionType.Description.class,
    com.concretepage.site_connect.RateQualifierType.RateComments.RateComment.class,
    com.concretepage.site_connect.ParagraphType.ListItem.class,
    com.concretepage.site_connect.TravelerInfoType.AirTraveler.Comment.class,
