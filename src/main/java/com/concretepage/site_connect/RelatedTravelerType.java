...
@XmlSeeAlso({
    com.concretepage.site_connect.CruiseGuestInfoType.LinkedBookings.LinkedBooking.class,
    com.concretepage.site_connect.CruiseGuestDetailType.LinkedTraveler.class
})
